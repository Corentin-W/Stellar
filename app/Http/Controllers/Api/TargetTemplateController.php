        ...
        $templates = $query->orderBy('display_order')
                          ...
                          ->map(function($template) {
                              return [
                                  ...
                                  'tips' => $template->tips,
                                  'preview_image' => $template->preview_image ? asset('storage/' . $template->preview_image) : null,
                                  'thumbnail_image' => $template->thumbnail_image ? asset('storage/' . $template->thumbnail_image) : null,
                                  'gallery_images' => $template->gallery_images ? collect($template->gallery_images)->map(fn($img) => asset('storage/' . $img))->toArray() : [],
